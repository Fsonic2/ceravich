...
// import api from "../../api/api"; // 🔥 use when connecting Laravel
...
export default function EditOrder() {
  ...
  // 🔥 Fetch Order (replace with API later)
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Order updated:", { id, ...form });
  ...
  return (
    <AdminLayout>
      <div className="container-fluid">
        <div className="mb-4">
          <h3 className="fw-bold mb-1">Edit Order</h3>
          <p className="text-muted">Update customer order information</p>
        </div>
